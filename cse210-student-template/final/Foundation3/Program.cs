...
class Program
{
    static void Main(string[] args)
    {
        ...
        Outdoors out1 = new Outdoors("Mountain Morning Meetup", "Start your day with a refreshing hike and scenic views. Great for all skill levels!", "June 10, 2026", "7:30 AM", add3,"Sunny with a cool breeze");
